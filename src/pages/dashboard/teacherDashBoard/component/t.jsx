import TeacherAppreciationVideo from "../../../assets/video/TeacherAprreciationvideo.mp4";
  ...
  return (
    <div className="min-h-screen  flex flex-col md:flex-row bg-gray-100">
      <div className="flex-1 p-4">
        ...
        <TotalTeacherStudent />
        {/* profile image upload and id image and intitution  starts here*/}
        <div className="flex flex-col md:flex-row w-full  max-h-3xl space-y-6 md:space-y-0 md:space-x-6">
      <div className="w-full md:w-1/2  bg-white shadow-lg p-6 rounded-lg">
        ...
        <form onSubmit={handleFormSubmit} className="space-y-6">
          <div className="relative w-40 h-40 mb-6 rounded-full overflow-hidden border-4 border-dashed border-gray-300 group mx-auto">
          ...
          <div>
            ...
            {singleTeacher && singleTeacher.institution ? (
              <p className="mt-2 block w-full p-2 border border-gray-300 rounded-md">
                {singleTeacher.institution}
              </p>
            ) : (
              <input
                type="text"
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center">
        ...
        {/* profile image upload and id image and intitution  ends here*/}

...
const WavyBackground = () => {
    ...
    if (container) {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        if (distance <= 0.6) {
          ...
          // Animate the sparkle falling and fading out
          setTimeout(() => {
            sparkle.style.transition = 'top 1s ease-out, opacity 1s ease-out';
            sparkle.style.top = '100%';
            sparkle.style.opacity = '0';
  
            // Remove the sparkle after the animation duration
            setTimeout(() => {
  ...
  return (
    <>
      <div className="pattern-dots w-full h-screen relative top-0 bg-[#070f1c] opacity-1" 
      ref={containerRef}
          ...
          <div className="flex w-[40%] flex-col justify-center">
            <div className="flex flex-col space-y-4 text-center lg:text-left">
              ...
              <h1 className="hero-title text-5xl text-white">
                Our{" "}
                <span className="primary-highlighter text-sky-500 text-6xl">
                  TutorCamp{" "}
                </span>
                Site{" "}
              </h1>
